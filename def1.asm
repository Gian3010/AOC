# Snake MIPS - Versão Final Restaurada (Posição das Paredes Fixada)
# Paredes: Centralizadas corretamente (Original).
# Estabilidade: Correções de "Travar ao Morrer" e "Loop Infinito" mantidas.
